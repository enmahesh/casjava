...
<jsp:useBean id="encryptionUtil" class="com.newgen.ibps.security.misc.RSAEncryptionUtility" scope="application"></jsp:useBean>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="w-0 px-2">
                                                            ...
                                                            <img src="${contextPath}/components/viewer/resources/images/maskcred.png" style="width: 25px;height: 25px;" onclick="toggleViewPassword(this, 'password');return false;">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
