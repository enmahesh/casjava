...
(function (e) {
	...
	var Webcam = {
		...
		params: {
			...
			noInterfaceFoundText: ERROR_MSG_INTERFACE,
			unfreeze_snap: true,
		...
		attach: function (a) {
			...
			if (this.userMedia) {
				...
				d.id = "takePhotoCanvas";
				var divRef = document.getElementById('cameraViewer');
				if(document.getElementById('takePhotoCanvas')!=null){
                    var canvasShowerDivRef= document.getElementById('canvasShower');
                    canvasShowerDivRef.removeChild(document.getElementById('takePhotoCanvas'));
                }
                var divWidth = divRef.style.width.split("p")[0] - 0;
                var divHeight = divRef.style.height.split("p")[0] - 80;
				d.style.width = "" + (divWidth-65) + "px";
				d.style.height = "" + divHeight + "px";
				d.style.position= "absolute";
				d.style.top = "30px";
				d.style.left = ((divWidth-(divWidth-65))/2)+"px";
				d.style.display = "none";
				var ele=document.getElementById('canvasShower');
				ele.appendChild(d);
